...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-sm-12">
            <cs:form_validate formId="refundAgentForm"/>
            <form class="form-horizontal" action="refund.cs" id="refundAgentForm" method="POST">
...
<script type="text/javascript">
    $("#submit").click(function () {
        ...
        if (amount < 0) {
            ...
            var id = $("#id").val();
            $.post("/agent/refund.cs", {"id": id, "amount": amount}, function (data) {

...
//
            String physicalPath = request.getSession().getServletContext().getRealPath(ImgPath.newsContentPath) + savePath;
            Util.mkDir(physicalPath.substring(0, physicalPath.lastIndexOf("/")));

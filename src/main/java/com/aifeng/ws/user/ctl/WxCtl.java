...
public class WxCtl {
    ...
    @Autowired
    public WxCtl(AgentService agentService, AuxiliaryInformationService auxiliaryInformationService) {
    ...
    @ResponseBody
    public String agentInfo(HttpServletRequest request, String name1) {
        try {
            ...
            agentService.saveAgent(name, mobile, IDCard, corpName, licenceImg, expireDate, addr);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "success";
